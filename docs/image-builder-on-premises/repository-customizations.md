...
installing a third-party package from the desired repository. You can find the blueprint reference for custom repositories [here](../image-builder-on-premises/blueprint-reference.md).
