...
In order to provide a stable base for the tests, the maintainer team created [the RPMRepo project](./rpmrepo.md) that periodically snapshots repositories of selected distributions.
